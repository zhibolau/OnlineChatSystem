...
//1.3 当有两个clients在list中 一个关闭了 但是没从list中拿出 再次写入str 当然会出错
//所以要在finally里删除关闭了的 client  所以client得在外面声明
    ...
    class Client implements Runnable{
        ...
        public void send(String str) {
            ...
            try {
                ...
                clients.remove(this);
                System.out.println("client has already been removed.");
                //e.printStackTrace();
            }
            //用throws 可以抓到SocketException SocketException is one of IOException,
        }
...
//                } s is already removed from main so this block should be removed
                    ...
                    //e.printStackTrace();
                    System.out.println("client existed. Bye.");
                } catch (IOException e1) {
                    e1.printStackTrace();
                }
            }
